...
public class DataLayer {
    ...
    public static final DataLayer GRANITE = new DataLayer(0, 0, 0, "Granite");
    public static final DataLayer DIORITE = new DataLayer(1,1, 1, "Diorite");
    public static final DataLayer GABBRO = new DataLayer(2,2, 2, "Gabbro");
    public static final DataLayer SHALE = new DataLayer(5,0, 3, "Shale");
    public static final DataLayer CLAYSTONE = new DataLayer(6,1, 4, "Claystone");
    public static final DataLayer ROCKSALT = new DataLayer(7,2, 5, "Rock Salt");
    public static final DataLayer LIMESTONE = new DataLayer(8,3, 6, "Limestone");
    public static final DataLayer CONGLOMERATE = new DataLayer(9,4, 7, "Conglomerate");
    public static final DataLayer DOLOMITE = new DataLayer(10,5, 8, "Dolomite");
    public static final DataLayer CHERT = new DataLayer(11,6, 9, "Chert");
    public static final DataLayer CHALK = new DataLayer(12,7, 10, "Chalk");
    public static final DataLayer RHYOLITE = new DataLayer(13,0, 11, "Rhyolite");
    public static final DataLayer BASALT = new DataLayer(14,1, 12, "Basalt");
    public static final DataLayer ANDESITE = new DataLayer(15,2, 13, "Andesite");
    public static final DataLayer DACITE = new DataLayer(16,3, 14, "Dacite");
    public static final DataLayer QUARTZITE = new DataLayer(17,0, 15, "Quartzite");
    public static final DataLayer SLATE = new DataLayer(18,1, 16, "Slate");
    public static final DataLayer PHYLLITE = new DataLayer(19,2, 17, "Phyllite");
    public static final DataLayer SCHIST = new DataLayer(20,3, 18, "Schist");
    public static final DataLayer GNEISS = new DataLayer(21,4, 19, "Gneiss");
    public static final DataLayer MARBLE = new DataLayer(22,5, 20, "Marble");
    ...
    public DataLayer(int index, int meta, int altMeta, String name) {
        this.layerID = index;
        this.data1 = altMeta;
        this.data2 = meta;
        this.name = name;
